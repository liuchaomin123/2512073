  ...
  return (
    <div className="absolute inset-0 pointer-events-none flex flex-col justify-end items-center pb-12 z-10">
      ...
      <div className="flex items-center gap-12 mb-8 pointer-events-auto">
          <button 
              onClick={onPrevPhoto}
              className="p-4 rounded-full border border-luxury-gold/30 bg-black/20 text-luxury-gold hover:bg-luxury-gold hover:text-luxury-green transition-all backdrop-blur-sm"
      ...
      <div className="flex gap-6 pointer-events-auto items-center">
        ...
        <button
          ...
          className={`
            ...
            rounded-sm shadow-[0_0_15px_rgba(255,215,0,0.15)]
          `}
        >
